<form id="new-task-form" class="needs-validation" novalidate>
    <div class="form-floating">
        <input aria-describedby="new-task-name-feedback" placeholder="" class="form-control" type="text" name="name"
            id="new-task-name" value="{{ old('name') }}" minlength=4 maxlength=255 required>
    ...
    <div class="form-floating">
        <textarea placeholder="" class="form-control auto-resize" aria-describedby="new-task-description-feedback"
            name="description" id="new-task-description" minlength=6 maxlength=512></textarea>
    ...
    <div class="form-floating">
        <select @class(['form-select', 'is-invalid' => $errors->has('task-group')]) aria-describedby="new-task-group-feedback" name="task_group_id"
    ...
    <label class="d-flex flex-column gap-1">
        Tags
        <select @class(['form-select', 'is-invalid' => $errors->has('tags')]) aria-describedby="new-task-tags-feedback" name="tags[]" id="new-task-tags"
            multiple>
