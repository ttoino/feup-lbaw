...
<span @class(['d-none' => $item->$edit_date == null, 'fst-italic'])
    data-render-class-condition="edit_date,d-none,false">Edited <time
        data-render-datetime="{{ $edit_date }}.iso"
        data-render-text="{{ $edit_date }}.long_diff"
