<header id="navbar">
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{ route('home') }}">
            <img src="{{ asset('logo.svg') }}" alt="Atrellado logo" width="40" height="40">
            <h1 class="h4 m-0">
        ...
        @auth
            <div class="dropdown">
                <a href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false"
                    ...
                    <img width="40" height="40" alt="Profile picture" src="{{ asset(Auth::user()->profile_pic) }}"
                        class="rounded-circle">
                    @if (Auth::user()->unreadNotifications->count())
                        <span style="padding: .375rem" class="position-absolute top-0 end-0 bg-danger rounded-circle">
